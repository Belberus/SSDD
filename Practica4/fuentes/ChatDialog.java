 ...
 * Sencilla implementacion de una interfaz grafica de usuario para aplicaciones de chat.
 * Autor: Javier Celaya, 2013
 * jcelaya@unizar.es
 * Este codigo puede ser reproducido y modificado con libertad, mientras se mantenga su autoria.
 */
...
public class ChatDialog extends JFrame {
	...
	public ChatDialog(final ActionListener l) {
		// Todo el codigo que modifica componentes de Swing debe ejecutarse
